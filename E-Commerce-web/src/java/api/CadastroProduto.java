...
import beans.BeanCadastroProdutoRemote;
 ...
 * @author vini1
 */
@WebServlet(name = "CadastraProduto", urlPatterns = {"/cadastroproduto"})
public class CadastroProduto extends HttpServlet {
    @EJB
   private  BeanCadastroProdutoRemote bean;
    /**
 ...
 try (PrintWriter out = response.getWriter()) {
            ...
            produto.setMarca(dataJSON.getJsonString("marca").getString());
            produto.setCor(dataJSON.getJsonString("cor").getString());
            produto.setTipo(dataJSON.getJsonString("tipo").getString());
            produto.setDescricao(dataJSON.getJsonString("descricao").getString());
            produto.setDescricao(dataJSON.getJsonNumber("valor").toString());
           
            String msg = bean.cadastroProduto(produto) ? "sucesso" : "falha";
